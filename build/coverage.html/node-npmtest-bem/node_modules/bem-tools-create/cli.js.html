...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-bem/node_modules/bem-tools-create/cli.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-bem/node_modules/bem-tools-create/cli.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-bem/node_modules/bem-tools-create/</a> &#187; cli.js</div>
</div>
<div class="body">
...
module.exports = function() {
    this
        ...
        .arg()
            ...
            .arr()
            .end()
        .act(<span class="fstat-no" title="function not covered" >function(opts, args) {</span>
<span class="cstat-no" title="statement not covered" >            var options = {},</span>
                techs = opts.addTech || [];
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (opts.forceTech) {</span>
<span class="cstat-no" title="statement not covered" >                options.onlyTech = opts.forceTech;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (args.entities) {</span>
<span class="cstat-no" title="statement not covered" >                return create(args.entities, opts.level, techs, options);</span>
            };
&nbsp;
<span class="cstat-no" title="statement not covered" >            opts.block &amp;&amp; create([{</span>
                block: opts.block[0],
